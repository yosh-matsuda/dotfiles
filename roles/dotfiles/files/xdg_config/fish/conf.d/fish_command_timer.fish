...
if not set -q fish_command_date_color
  set fish_command_date_color yellow
end
...
function fish_command_timer_compute_cmd_duration_str
  ...
  if [ $num_days -gt 1 ]
    set cmd_duration_str {$cmd_duration_str}{$num_days}" days "
  else if [ $num_days -gt 0 ]
    set cmd_duration_str {$cmd_duration_str}{$num_days}" day "
  end
  if [ $num_hours -lt 10 ]
    set num_hours "0"{$num_hours}
  end
  set cmd_duration_str {$cmd_duration_str}{$num_hours}":"
  if [ $num_mins -lt 10 ]
    set num_mins "0"{$num_mins}
  end
  set cmd_duration_str {$cmd_duration_str}{$num_mins}":"
  ...
  if [ $num_secs -lt 10 ]
    set num_secs "0"{$num_secs}
  end
  set cmd_duration_str {$cmd_duration_str}{$num_secs}.{$num_millis_pretty}
